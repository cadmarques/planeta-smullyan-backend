...
const puzzleDetailsRoutes = require('./routes/puzzleDetailsRoutes'); // Adicionamos as rotas de PuzzleDetails
...
app.use('/api/puzzle-details', puzzleDetailsRoutes); // Adicionamos as rotas de PuzzleDetails
